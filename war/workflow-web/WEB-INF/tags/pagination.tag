...
<%@ attribute name="page" type="com.ztj.wood.common.model.Page" required="true"%>
<%@ attribute name="paginationSize" type="java.lang.Integer" required="true"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%
    int current =  page.getPageIndex();
    long begin = Math.max(1, current - paginationSize/2);
    long end = Math.min(begin + (paginationSize - 1),page.getTotalPage());
...
<div class="pagination pagination-centered">
    <ul>
        ...
        <% if (current != 1 || (current == end && current != 1)){%>
        ...
        <% if (page.getStart()!=page.getTotalPage()){%>
        <li><a href="?p=${current+1}&ps=${page.pageSize}&${page_params}">&gt;</a></li>

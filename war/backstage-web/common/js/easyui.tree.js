...
if(_5e.nodefield)_5f.attr("node-field",_5e.nodefield);
$.data(_5f[0],"tree-node",{id:_5e.id,text:_5e.text,iconCls:_5e.iconCls,attributes:_5e.attributes,nodefield:_5e.nodefield});
$("<span class=\"tree-title\"></span>").html(_56.formatter?_56.formatter.call(_53, _5e):_5e.text).appendTo(_5f);
if(_56.checkbox){
...
nt.empty();
var _dc=$("<input maxlength=\"32\" class=\"tree-editor\">").appendTo(nt);
...
$(function(){
	$.extend($.fn.tree.methods,{
		getCheckedExt: function(jq){
			...
			var checkbox2 = $(jq).find("span.tree-checkbox2:not(:first)").parent(); //获取实心的选项 也就是实心方块的 

...
(function($) {
    ...
    function _9(_a, _b) {   //设置表格的宽度和表格的panel的宽度
        var _c = $.data(_a, "datagrid").options;
        var _d = $.data(_a, "datagrid").panel;
        if (_b) {
            if (_b.width) {
                _c.width = _b.width;   //_c是表格options中的width
            }
            if (_b.height) {
                _c.height = _b.height;
            }
    ...
    function _34(_35, _36) {	//_35是table _36是rownumbers
        function _37() {	//当表头在页面用th定义是用
            var _38 = [];
            var _39 = [];
            $(_35).children("thead").each(function() {  //当在html中用th的方法定义表格时返回各个参数
        ...
        _3b.panel("panel").addClass("datagrid").bind("_resize", function(e, _3c) { //bind了resize,但并没有触发，所以不执行
            var _3d = $.data(_35, "datagrid").options;   //_3d是options
            if (_3d.fit == true || _3c) { 
                _9(_35);  //_9在45行，设置表格的宽度和表格的panel的宽度
                setTimeout(function() {
        ...
        var cc = _37();   //当在html页面中用th的方法定义表格时返回各个参数
    ...
    function _47(_48) {
        ...
        function _4e(_55, _56, _57) {  //创建table-header
            if (!_56) {
                return;
            }
            $(_55).show();
    ...
    function _5d(_5e) {
		...
		function _scl(t){
			//var i=1;
			//var n=t.find("tr").size()||0;
			_61.onScroll.call(t,t,_5e);
    ...
    function _73(_74) {
        ...
        function _7f(col, _80) {
            ...
            col.width += _80;
            col.boxWidth += _80;
			if(col.boxWidth < 0)col.boxWidth = 0;
        ...
        function fix(_92) {
            ...
            for (var i = 0, len = _95.length; i < len; i++) {
                ...
                if (_96.selectorText.toLowerCase() == col.cellSelector.toLowerCase()) {
                	try{
                		_96.style["width"] = col.boxWidth + "px";
                	}catch(e){
                		_96.style.width = col.boxWidth + "px";
                	}
                    break;
        ...
        tr.children("td").each(function() {
            ...
            if (col && col.editor) {
                ...
                if (_121) {
					...
					cell.css({paddingLeft:1,paddingRight:1});
                    cell.addClass("datagrid-editable");
                    cell._outerWidth(_123);
                    cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td rowid=\"" + (row.id || "") + "\"></td></tr></table>");
    ...
    function _150(_151, _152) {
		...
		var checkAll = $("div.datagrid-header-check input[type=checkbox]");
		if(checkAll.is(":checked"))checkAll.prop({checked: false});
    ...
    $.fn.datagrid = function(_15a, _15b) {
        ...
        return this.each(function() {
            ...
            if (_15c) { 
                ...
                var _15d = _34(this, opts.rownumbers);   //_34包裹各个div
                if (!opts.columns) { 
    ...
    var _15e = {
        ...
        checkbox : {
            init : function(_16f, _170) {
				...
				//_171.attr("checked", _170.checked);
				
				if(_170.checked){$(_171).attr("checked", true)}
                return _171;
            },
        ...
        validatebox : {
            init : function(_17f, _180) {
                var _181 = $("<input rowid=\"" + $(_17f).attr("rowid") + "\" type=\"text\" class=\"datagrid-editable-input\">").appendTo(_17f);
    ...
    $.fn.datagrid.parseOptions = function(_1c8) {  //_1c8是表格
        var t = $(_1c8);
        ...
        });  //$.parser.parseOptions是easyui中定义的
    };
    var _1c9 = {
            ...
            for (var i = 0; i < _1d9.length; i++) {
                ...
                if (col) {
                    ...
                    if (col.checkbox) {
                    	...
                    	if(col.withTitle)cc.push('title="' + _1df + '"');
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        url : null,
        data : null,
        loadMsg : '&emsp;',//decodeURI('&#x52A0;&#x8F7D;&#x4E2D;&#xFF0C;&#x8BF7;&#x7A0D;&#x7B49;......'),
        rownumbers : false,
        singleSelect : false,
        selectOnCheck : true,
        checkOnSelect : true,
